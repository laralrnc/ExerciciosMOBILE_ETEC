...
public class ExcluirFerramentaActivity extends Activity {

 TextView txtnome_ferramenta, txtfabricante, txtpreco,txtcor,
 txtreferencia;
...
protected void onCreate(Bundle savedInstanceState) {
 ...
 txtnome_ferramenta = (TextView)
 findViewById(R.id.txtnome_ferramenta);
 txtfabricante = (TextView)
 findViewById(R.id.txtfabricante);
 txtpreco = (TextView) findViewById(R.id.txtpreco);
 txtcor = (TextView) findViewById(R.id.txtcor);
 txtreferencia = (TextView)
 findViewById(R.id.txtreferencia);
 ...
 btexcluir_ferramenta.setOnClickListener(new
 ...
 (ExcluirFerramentaActivity.this);
