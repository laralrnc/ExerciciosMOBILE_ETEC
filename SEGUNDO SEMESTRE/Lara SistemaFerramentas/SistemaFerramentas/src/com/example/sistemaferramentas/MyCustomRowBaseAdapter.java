...
public MyCustomRowBaseAdapter(Context context,
 ArrayList<DadosFerramenta> dadosFerramenta)
 {
...
public View getView(int position, View convertView, ViewGroup
 ...
 (R.layout.custom_row_lisview, null);
 holder = new ViewHolder();

 holder.txtnomeferramenta = (TextView)
 convertView.findViewById(R.id.txtnome_ferramenta);
 holder.txtfabricante = (TextView)
 convertView.findViewById(R.id.txtfabricante);
 holder.txtreferencia = (TextView)
 convertView.findViewById(R.id.txtreferencia);
 ...
 (position).fabricante);
 holder.txtreferencia.setText(dadosFerramentaArrayList.get
 (position).referencia);
